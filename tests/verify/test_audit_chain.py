...
def test_merkle_inclusion_and_tamper_detection(temp_audit_env):
    ...
    is_valid = MerkleTree.verify_proof(proof_data["leaf"], proof_data["proof"], proof_data["root"])
    ...
    is_valid_tampered = MerkleTree.verify_proof(
        tampered_leaf, proof_data["proof"], proof_data["root"]
    )
...
def test_merkle_proof_manipulation(temp_audit_env):
    ...
    is_valid = MerkleTree.verify_proof(proof_data["leaf"], manipulated_proof, proof_data["root"])

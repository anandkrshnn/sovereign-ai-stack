...
from sovereign_ai.rag.policy import AccessRequest, PolicyEngine
...
def test_signed_policy_lifecycle(tmp_path):
    ...
    engine = PolicyEngine(
        policy_path=str(policy_file), trusted_public_key=pub_b64, strict_mode=True
    )

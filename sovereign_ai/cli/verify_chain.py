...
def main():
    parser = argparse.ArgumentParser(description="Offline cryptopgrahic verification of Sovereign Audit Chains.")
    parser.add_argument("--tenant", required=True, help="Tenant ID to verify.")
    parser.add_argument("--base-dir", default="data", help="Base directory containing the tenant's logs.")

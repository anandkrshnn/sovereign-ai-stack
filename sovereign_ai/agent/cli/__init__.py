...
@app.command()
def start(
    daemon: bool = typer.Option(False, "--daemon", "-d", help="Run SovereignAIAgent in the background as a daemon"),
    ...
    if daemon:
        ...
        console.print(Panel("[bold green]Starting SovereignAIAgent in foreground mode...[/bold green]"))

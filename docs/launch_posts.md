...
[Link to GitHub Repo]
#ZeroTrust #SovereignAI #DevSecOps #RAG #MachineLearning #Cybersecurity

---

## 2. Hacker News Launch (Show HN)

**Title**: Show HN: Sovereign AI Stack v2.0 – A hardware-attested, fail-closed local RAG airlock
...
- It logs every event to an append-only JSONL ledger backed by Ed25519 signatures and O(1) Merkle inclusion proofs.
